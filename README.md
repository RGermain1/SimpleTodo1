# Project 2 - *Simple Todo*

**Simple Todo** shows the latest movies currently playing in theaters. The app utilizes the Movie Database API to display images and basic information about these movies to the user.
...
## License
    ...
    Copyright [2019] [Germain Roselin]
